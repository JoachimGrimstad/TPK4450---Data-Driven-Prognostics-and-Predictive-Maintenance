...
title:          Problem10a
version:        1.0.0
fileName:       Problem10a.py 
author:         Joachim Nilsen Grimstad
description:    Problem 10a, semester work II, TPK–4450, Autumn 2020 @NTNU                                
...
List_of_RULs = [time - 60 for time in threshold_times]                                          # List Of linear RULs
...
print(f'a) The probability is: {Probability}')
