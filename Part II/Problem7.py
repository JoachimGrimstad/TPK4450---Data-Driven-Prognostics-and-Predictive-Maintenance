...
title:          Problem7
version:        1.0.0
fileName:       Problem7.py 
author:         Joachim Nilsen Grimstad
description:    Problem 7, semester work II, TPK–4450, Autumn 2020 @NTNU                                
...
simulation_time = 120                                                                           # Simualte from t = 0 to simulation time. 
...
sns.lineplot(data = df, x = 't', y = 'Y(t)', label = 'Y(t)')                                                                                        # Plots Y(t)
